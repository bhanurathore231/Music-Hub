				...
				<div id="wt-twocolumns" class="wt-twocolumns wt-haslayout">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4 float-left">
						<aside id="wt-sidebar" class="wt-sidebar">
							...
							<?php if (function_exists('workreap_prepare_project_social_sharing')) { workreap_prepare_project_social_sharing(false, esc_html__('Share This Label', 'workreap'), 'true', '', $employer_avatar); }?>
