	...
	function workreap_advance_search_where_freelancers($where){
        ...
        if( is_page_template( 'directory/freelancer-search.php' ) ) {
			 ...
			 $where  .= " AND (
				...
				OR (tt.taxonomy = 'school' AND t.name LIKE '%".$keyword."%') 
	...
	function workreap_save_freelancer_html( $id='', $type ='v1' ) {
		...
		if ($type == 'v1') {
			if ( in_array($id, $saved_freelancers) ) {?>
				<a href="#" onclick="event_preventDefault(event);" class="wt-clicksave wt-btn wt-send-offers msg-btn-profile"><span><?php esc_html_e('Saved in favourites','workreap');?></span></a>
			<?php } else {?>
				<a href="#" onclick="event_preventDefault(event);" class="wt-clicksave wt-savefreelancer wt-btn wt-send-offers msg-btn-profile" data-id="<?php echo intval( $id );?>" data-text="<?php esc_attr_e('Saved in favourites', 'workreap'); ?>"><span><?php esc_html_e('Add to favourites', 'workreap'); ?></span></a>
			<?php
			}
		} else if ($type == 'v2') {
			if ( in_array($id, $saved_freelancers) ) {?>
				<a href="#" onclick="event_preventDefault(event);" class="wt-liked"><?php esc_html_e('Saved','workreap');?></a>
			<?php } else {?>
				<a href="#" onclick="event_preventDefault(event);" class="wt-savefreelancer" data-type="v2" data-id="<?php echo intval( $id );?>" data-text="<?php esc_attr_e('Saved', 'workreap'); ?>"><span><?php esc_html_e('Add to favourites', 'workreap'); ?></span></a>
			<?php
			}
		} else if ($type == 'v3') {
			if ( in_array($id, $saved_freelancers) ) {?>
				<a href="#" onclick="event_preventDefault(event);" class="wt-likeproject wt-likedpro"></a>
			<?php } else { ?>
		...
		if( !empty( $emp_followers ) ){
			...
			<div class="wt-widget">
				<div class="wt-widgettitle">
					<h2><?php esc_html_e('Label Followers', 'workreap'); ?></h2>
				</div>
 ...
 */
 if( !function_exists( 'workreap_keyword_search') ){
    function workreap_keyword_search( $classes = ''){
		...
		?>
        <div class="wt-widget wt-startsearch <?php echo esc_attr($classes);?>"style="display:none;">
			<div class="wt-widgettitle">
			...
			<div class="wt-widgetcontent" style="display: none;">
				<div class="wt-formtheme wt-formsearch">
					<fieldset>
						<div class="form-group">
