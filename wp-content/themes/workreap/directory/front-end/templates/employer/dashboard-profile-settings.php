	...
	<form class="wt-user-profile">	
		<div class="wt-dashboardbox wt-dashboardtabsholder">
			<div class="wt-dashboardtabs">
				<ul class="wt-tabstitle nav navbar-nav">
					...
					<li class="nav-item wt-list-view-my-profile">
						<a class="" href="<?php echo get_site_url()?>/dashboard/?ref=chat&identity=<?php echo $user_identity;?>"><?php esc_html_e('Messages','workreap'); ?></a>
					</li>
					...
					<?php } ?>
						...
						<li class="nav-item wt-list-brochures">
							<a data-toggle="tab" href="#wt-brochures"><?php esc_html_e('Delete Account', 'workreap'); ?></a>
						</li>
			...
			<div class="wt-tabscontent tab-content">
				...
				<div class="wt-personalskillshold tab-pane fade" id="view-my-profile">
				    <?php //get_template_part('directory/front-end/templates/employer/dashboard', 'view-my-profile'); ?>
				</div>
				<?php if(!empty($socialmediaurl) && $socialmediaurl  ==='enable'){?>
