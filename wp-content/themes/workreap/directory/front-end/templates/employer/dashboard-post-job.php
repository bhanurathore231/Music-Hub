				...
				<div class="wt-dashboardboxcontent">
									...
									<div class="form-group form-group-half wt-formwithlabel">
										...
										<span class="wt-selects toolip-wrapo">
											...
											<select name="job[job_option]" class="chosen-select">
												...
												<option value="">
												<?php esc_html_e('Project location type','workreap');?></option>
					...
					<div class="wt-category-holder wt-tabsinfo wt-dropdown-categories">
						...
						<div class="wt-tabscontenttitle">
							...
							<h2><?php esc_html_e('Job Artist Type','workreap');?></h2>
						...
						<div class="wt-divtheme wt-userform wt-userformvtwo">
							...
							<div class="form-group">
								...
								<?php do_action('workreap_get_project_artist_type_list','job[artist_type][]','');?>
...
<div class="wt-tabscontenttitle">
	...
	<h2><?php esc_html_e('Job Music Genre','workreap');?></h2>
...
<div class="wt-divtheme wt-userform wt-userformvtwo">
	...
	<div class="form-group">
		...
		<?php do_action('workreap_get_project_music_genre_list','job[music_genre][]','');?>
...
<div class="wt-tabscontenttitle">
	...
	<h2><?php esc_html_e('Job Number of Members','workreap');?></h2>
...
<div class="wt-divtheme wt-userform wt-userformvtwo">
	...
	<div class="form-group">
		...
		<?php do_action('workreap_get_project_number_of_members_list','job[number_of_members][]','');?>
...
<div class="wt-tabscontenttitle">
	...
	<h2><?php esc_html_e('Job Instruments Associated with Act','workreap');?></h2>
...
<div class="wt-divtheme wt-userform wt-userformvtwo">
	...
	<div class="form-group">
		...
		<?php do_action('workreap_get_project_instruments_associated_with_act_list','job[instruments_associated_with_act][]','');?>
...
<div class="wt-tabscontenttitle">
	...
	<h2><?php esc_html_e('Job Age Range','workreap');?></h2>
...
<div class="wt-divtheme wt-userform wt-userformvtwo">
	...
	<div class="form-group">
		...
		<?php do_action('workreap_get_project_age_range_list','job[age_range][]','');?>
...
<div class="wt-tabscontenttitle">
	...
	<h2><?php esc_html_e('Job Years Performing','workreap');?></h2>
...
<div class="wt-divtheme wt-userform wt-userformvtwo">
	...
	<div class="form-group">
		...
		<?php do_action('workreap_get_project_years_performing_list','job[years_performing][]','');?>
...
<div class="wt-tabscontenttitle">
	...
	<h2><?php esc_html_e('Job School','workreap');?></h2>
...
<div class="wt-divtheme wt-userform wt-userformvtwo">
	...
	<div class="form-group">
		...
		<?php do_action('workreap_get_project_school_list','job[school][]','');?>
...
<div class="wt-tabscontenttitle">
	...
	<h2><?php esc_html_e('Job Next Gig','workreap');?></h2>
...
<div class="wt-divtheme wt-userform wt-userformvtwo">
	...
	<div class="form-group">
		...
		<?php do_action('workreap_get_project_next_gig_list','job[next_gig][]','');?>
...
<div class="wt-tabscontenttitle">
	...
	<h2><?php esc_html_e('Job City','workreap');?></h2>
...
<div class="wt-divtheme wt-userform wt-userformvtwo">
	...
	<div class="form-group">
		...
		<?php do_action('workreap_get_project_city_list','job[city][]','');?>
...
<div class="wt-tabscontenttitle">
	...
	<h2><?php esc_html_e('Job Country','workreap');?></h2>
...
<div class="wt-divtheme wt-userform wt-userformvtwo">
	...
	<div class="form-group">
		...
		<?php do_action('workreap_get_project_country_list','job[country][]','');?>
...
<div class="wt-tabscontenttitle">
	...
	<h2><?php esc_html_e('Job Representation','workreap');?></h2>
...
<div class="wt-divtheme wt-userform wt-userformvtwo">
	...
	<div class="form-group">
		...
		<?php do_action('workreap_get_project_representation_list','job[representation][]','');?>
