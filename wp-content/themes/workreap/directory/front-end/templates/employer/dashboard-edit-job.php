	...
	<?php 
		if ( intval($url_identity) === intval($post_author) ) {
			...
			while ($query->have_posts()) : $query->the_post();
				...
				//dinesh
				$db_artist_type = wp_get_post_terms($post->ID, 'artist_type');
				...
				//dinesh
				$db_artist_type	= !empty( $db_artist_type ) ? wp_list_pluck($db_artist_type,'term_id') : array();
				...
				<div class="wt-dashboardbox">
					...
					<div class="wt-dashboardboxcontent">
						...
						<div class="wt-category-holder wt-tabsinfo">
							...
							<div class="wt-divtheme wt-userform wt-userformvtwo">
								<div class="form-group">
									<?php do_action('workreap_get_project_artist_type_list','job[artist_type][]',$db_artist_type);?>	
								</div>
							</div>
						</div>
