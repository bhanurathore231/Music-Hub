			...
			<fieldset>
				...
				<div class="form-group">
					...
					<span class="wt-select">
						...
						<option value="" disabled selected>Select a reason to leave in the box</option>
				...
				<div class="form-group">
					...
					<textarea name="delete[description]" class="form-control" placeholder="<?php esc_attr_e('Description','workreap');?>"></textarea>
