...
<div class="wt-addprojectsholder">
	...
	<div class="wt-tabscontenttitle wt-addnew">
		...
		<h2><?php esc_html_e('Add Your Audio', 'workreap'); ?></h2>

		<span class="wt-add-project"><a href="#" onclick="event_preventDefault(event);"><?php esc_html_e('+ Add audio', 'workreap'); ?></a></span>
...
<li id="wt-award-{{data.counter}}" data-id="{{data.counter}}" class="wt-placehoder-img">
	...
	<div class="wt-accordioninnertitle">
		...
		<div class="wt-projecttitle collapsed" data-toggle="collapse" data-target="#innertitle-{{data.counter}}">
			...
			<h3><span class="head-title"><?php esc_html_e('Audio Link', 'workreap'); ?></span><span class="head-sub-title"><?php esc_html_e('www.example.com', 'workreap'); ?></span></h3>
		...
		<div class="wt-formtheme wt-userform wt-formprojectinfo">
			...
			<fieldset>
				...
				<div class="form-group form-group-half">
					...
					<input type="text" name="settings[project][{{data.counter}}][title]" class="wt-input-title form-control" placeholder="<?php esc_attr_e('Audio Title', 'workreap'); ?>">

				</div>

				<div class="form-group form-group-half">

					<input type="text" name="settings[project][{{data.counter}}][link]" class="wt-input-subtitle form-control" placeholder="<?php esc_attr_e('Audio URL', 'workreap'); ?>">
