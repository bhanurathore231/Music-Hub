...
$display_name	= !empty( $current_user->user_login ) ? $current_user->user_login : '';
...
<div class="wt-yourdetails wt-tabsinfo">
	...
	<!-- 		<?php //if( !empty( $gender_list ) ){?>
			...
			<label>Artist/Band Name</label>
				<input type="text" name="basics[display_name]" class="form-control" value="<?php echo esc_attr( $display_name ); ?>" placeholder="<?php esc_attr_e('Artist/Band name', 'workreap'); ?>">
