...
?>
<div class="wt-haslayout wt-innerbannerholder frinnerbannerholder wt-innerbannerholdervtwo profile-view" style="background-image:url('<?php echo esc_url( $freelancer_banner );?>');">
</div>