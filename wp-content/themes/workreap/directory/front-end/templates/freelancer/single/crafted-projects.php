...
if( !empty( $projects ) && is_array( $projects ) ){?>
	...
	<div class="wt-craftedprojects">
		...
		<div class="wt-usertitle">
			...
			<h2><?php esc_html_e('Audio','workreap');?></h2>
		...
		<?php 
			...
			<div class="wt-project wt-crprojects <?php echo do_shortcode( $item_show );?>">
				...
				<?php } else if( !empty( $image_url) ){?>
					...
					<figure>
						<a data-url="<?php echo esc_url($link);?>" class="hwe_open_audio_model" href="javascript:void(0);">
				...
				<?php if( !empty( $title ) ) { ?>
					...
					<div class="wt-projectcontent">
						...
						<a class="hwe_open_audio_model" data-url="<?php echo esc_url($link);?>" href="<?php echo esc_url($link);?>"><h3><?php echo esc_html(stripslashes($title));?></h3></a>
