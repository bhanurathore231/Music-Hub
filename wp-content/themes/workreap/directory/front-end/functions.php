...
if( !function_exists( 'worktic_get_search_list' ) ) {
	function worktic_get_search_list($is_single='no'){
		...
		$list = array(
	        ...
	        'acm' => array( 
	    		'title' 		=> esc_html__('Acm', 'workreap'),
	    	),
			'bimm' => array( 
	    		'title' 		=> esc_html__('Bimm', 'workreap'),
	    	),
			'city_academy' => array( 
	    		'title' 		=> esc_html__('City Academy', 'workreap'),
	    	),
			'garnish_music_production' => array( 
	    		'title' 		=> esc_html__('Garnish Music Production', 'workreap'),
	    	),
			'icmp' => array( 
	    		'title' 		=> esc_html__('Icmp', 'workreap'),
	    	),
			'lipa' => array( 
	    		'title' 		=> esc_html__('Lipa', 'workreap'),
	    	),
			'nexus_ica' => array( 
	    		'title' 		=> esc_html__('Nexus Ica', 'workreap'),
	    	),
			'point_black_music_school' => array( 
	    		'title' 		=> esc_html__('Point Black Music School', 'workreap'),
	    	),
			'song_academy' => array( 
	    		'title' 		=> esc_html__('Song Academy', 'workreap'),
	    	),
			'the_song_writing_academy' => array( 
	    		'title' 		=> esc_html__('The Song Writing Academy', 'workreap'),
	    	),
		);
...
if ( ! function_exists( 'workreap_get_account_delete_reasons' ) ) {
	function workreap_get_account_delete_reasons($key='') {
		global $current_user;
		$list = array(
			'cannot_afford_the_subscription' => esc_html__('Cannot afford the subscription','workreap'),
			'am_no_longer_playing_music' 	=> esc_html__('Am no longer playing music','workreap'),
			'service_was_not_as_expected' 	=> esc_html__('Service was not as expected','workreap'),
