                ...
                (jQuery(".wpem-event-list-layout").length > 0 || jQuery(".wpem-event-box-layout").length > 0) &&
                    ("line-layout" == localStorage.getItem("layout")
                        ? /*(jQuery(".wpem-event-box-col").show(),
                          ...
                          jQuery(".wpem-event-listings").hasClass("wpem-row") && jQuery(".wpem-event-listings").removeClass("wpem-row"),
						  ...
						  */(jQuery(".wpem-event-box-layout").removeClass("wpem-active-layout"),
                          jQuery(".wpem-event-list-layout").addClass("wpem-active-layout"),jQuery('#hwe_show_custom_event_calender').show(),jQuery('#event-listing-view').hide())
                        ...
                        ? /*(jQuery(".wpem-event-box-col").hide(),
                          ...
                          jQuery(".wpem-event-listings").hasClass("wpem-row") || jQuery(".wpem-event-listings").addClass("wpem-row"),
                          jQuery(".wpem-event-listings").removeClass("wpem-event-listing-list-view"),
                          jQuery(".wpem-event-listings").removeClass("wpem-event-listing-box-view"),
                          jQuery(".wpem-event-listings").addClass("wpem-event-listing-calendar-view"))*/(jQuery('#hwe_show_custom_event_calender').hide(),jQuery('#event-listing-view').show())
                        : /*(jQuery(".wpem-event-box-col").show(),
                          jQuery(".wpem-event-list-layout").removeClass("wpem-active-layout"),
                          jQuery(".wpem-event-box-layout").addClass("wpem-active-layout"),
                          jQuery(".wpem-event-listings").hasClass("wpem-row") || jQuery(".wpem-event-listings").addClass("wpem-row"),
                          jQuery(".wpem-event-listings").removeClass("wpem-event-listing-list-view"),
                          jQuery(".wpem-event-listings").addClass("wpem-event-listing-box-view"))*/(jQuery(".wpem-event-list-layout").removeClass("wpem-active-layout"),
                          jQuery(".wpem-event-box-layout").addClass("wpem-active-layout"),jQuery('#hwe_show_custom_event_calender').hide(),jQuery('#event-listing-view').show())),
                setTimeout(function () {
                    jQuery("input.date_range_picker").length > 0 &&
                        jQuery("input.date_range_picker").daterangepicker({
                            datepickerOptions: { numberOfMonths: 2, minDate: null, maxDate: null, monthNames: event_manager_content_event_listing.i18n_monthNames },
        ...
        actions: {
            lineLayoutIconClick: function (e) {
                Common.logInfo("ContentEventListing.actions.lineLayoutIconClick..."),
					...
					*/
					jQuery(this).addClass("wpem-active-layout"),
                    jQuery("#wpem-event-box-layout").removeClass("wpem-active-layout"),
					jQuery('#event-listing-view').hide(),
					jQuery('#hwe_show_custom_event_calender').show(),
            ...
            boxLayoutIconClick: function (e) {
                Common.logInfo("ContentEventListing.actions.boxLayoutIconClick..."),
                    /*jQuery(this).addClass("wpem-active-layout"),
                    jQuery("#wpem-event-list-layout").hasClass("wpem-active-layout") && jQuery("#wpem-event-list-layout").removeClass("wpem-active-layout"),
                    jQuery(".wpem-event-box-col").show(),
                    jQuery(".wpem-event-listings").removeClass("wpem-event-listing-list-view"),
					...
					*/
					jQuery(this).addClass("wpem-active-layout"),
                    jQuery("#wpem-event-list-layout").hasClass("wpem-active-layout") && jQuery("#wpem-event-list-layout").removeClass("wpem-active-layout"),
					jQuery('#hwe_show_custom_event_calender').hide(),
					jQuery('#event-listing-view').show(),
