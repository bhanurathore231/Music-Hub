	...
	*/
	...
	public function submit() {
		...
		get_event_manager_template( 'event-submit.php', array(
			...
			'step'           	=> $this->get_step(),
			'submit_button_text' => apply_filters( 'submit_event_form_submit_button_text', __( 'Submit', 'wp-event-manager' ) ),
		) );
	}
	...
	public function submit_handler() {
		try {
			...
			// Update the event
			$this->save_event( $values['event']['event_title'], $values['event']['event_description'], $this->event_id ? '' : 'pending', $values );
