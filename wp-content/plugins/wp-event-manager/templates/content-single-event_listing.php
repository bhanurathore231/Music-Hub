                               ...
                               <?php
                                ...
                                <div class="wpem-single-event-sidebar-info">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="wpem-heading-text" style="padding-top: 15px;">Artist Name:</h3>
                                        <a class="event-artist-profile" href="<?php echo get_site_url();?>/freelancer/<?php echo $nicename; ?>"><?php echo $display_name; ?></a>
                                        </div>
                                    </div>
